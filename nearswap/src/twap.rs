...
impl Twap {
    ...
    pub fn initialize(observation: Twap[], time: U128)
        -> (U128, U128)
    {
        observation[0] = Twap {
            blockTimestamp: time,
    ...
    pub fn write(
        ...
        self[indexUpdated] = transform(last, blockTimestamp, price0, price1);
    }
    ...
    function grow(
        ...
        let mut i = current;
        while i < next {
            observation[i].blockTimestamp = 1;
            i += 1;
        }
